# PreAutoTestFasForwardMerge - Test: fast-forward merge with master
...
- Create a variable called _Decorator.GitAutoTestFastForwardMerge.Enabled_ and set it to _true_.
